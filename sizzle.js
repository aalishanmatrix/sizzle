...
try {
	...
	// Since the BlackBerry implementation doesn't raise an exception per se, let's just check that the first element has a node type. If it's
	// undefined, it'll raise an exception.
